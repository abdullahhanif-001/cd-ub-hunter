...
Engineering verification for the VPS deployment wrapper. Upstream CompDiff/AFL++ carry their own upstream test harnesses under `vendor/CompDiff/` (not committed).
...
| [evidence/](evidence/) | Production run artifacts (real VPS verification) |
